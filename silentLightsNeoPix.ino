...
//--------------------------------------------------------------------------------
  ...
  void loop() {
    ...
    wave(strip1.Color(0, 0, 255), 10);
    reverseWave(strip1.Color(40, 0, 255), 10);
    wave(strip1.Color(0, 100, 255), 10);
    initialize();
    blinky(strip1.Color(0, 0, 255), 10);
    blinky(strip1.Color(40, 0, 255), 10);
    blinky(strip1.Color(0, 100, 255), 10);
